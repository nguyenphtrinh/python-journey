...
so_tien_ban_dau = 150_000
gia_ca_phe = 35_000
so_ly = 3
so_tien_con_lai = so_tien_ban_dau - (gia_ca_phe * so_ly)
...
tong_keo = 100
so_nguoi = 7
keo_moi_nguoi = tong_keo // so_nguoi
keo_du = tong_keo % so_nguoi
print(f"Mỗi người được: {keo_moi_nguoi} viên kẹo")
print(f"Còn dư: {keo_du} viên kẹo")
