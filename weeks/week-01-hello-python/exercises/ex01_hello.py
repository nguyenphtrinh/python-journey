...
print("Tôi thích học lập trình Python")
...
# H   H  III
# Viết code ở đây:
print("TTTTT  RRRR   III  N   N  H   H")
print("  T    R   R   I   NN  N  H   H")
print("  T    RRRR    I   N N N  HHHHH")
print("  T    R R     I   N  NN  H   H")
print("  T    R  RR  III  N   N  H   H")
